...
#     pr_barcode=models.CharField(max_length=200)
#     pr_brand=models.CharField(max_length=200)
#     pr_weight=models.CharField(max_length=100)
#     pr_category=models.CharField(max_length=200)
#     pr_sub_category=models.CharField(max_length=200)
#     pr_unit=models.CharField(max_length=100)

    
#     pr_cost=models.CharField(max_length=200)
#     pr_price=models.CharField(max_length=100)
#     pr_tax=models.CharField(max_length=100)
#     pr_tax_method=models.CharField(choices=CHOICES, default=False, max_length=20)
#     pr_alert_qty=models.CharField(max_length=100)
#     pr_qty=models.IntegerField()
#     pr_description=models.CharField(max_length=500)
#     pr_image=models.ImageField(upload_to='images', blank=True, null=True)
#     pr_user=models.IntegerField()
#     pr_date=models.DateTimeField(auto_now=True)
#     pr_made	=models.ForeignKey(tbl_made,null=True,on_delete=models.CASCADE)
#     pr_arti_code=models.CharField(max_length=300)
#     trash=models.BooleanField(default=False)